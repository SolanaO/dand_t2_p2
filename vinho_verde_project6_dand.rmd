...
ggplot(rwine, aes(x = quality, y = volatile.acidity, group=quality)) + 
  geom_boxplot(color='purple') +
  geom_jitter( position = position_jitter(0.3), alpha=0.08) +
  stat_summary(fun.y = median, geom='line', 
               size=.7, color='magenta', aes(group=1)) +
  geom_text(data=q_va, aes(x = quality, y = med, label = med), 
...
ggplot(rwine, aes(x = quality, y = citric.acid, group=quality)) + 
  geom_boxplot(color='purple') +
  geom_jitter( position = position_jitter(0.3), alpha=0.08) +
  stat_summary(fun.y = median, geom='line', 
               size=.7, color='magenta', aes(group=1)) +
  geom_text(data=q_ca, aes(x = quality, y = med, label = med), 
              size = 4, color= 'blue', vjust = -1)
...
ggplot(rwine, aes(x = quality, y = residual.sugar, group=quality)) + 
  geom_boxplot(color='purple') +
  geom_jitter( position = position_jitter(0.3), alpha=0.08) +
  stat_summary(fun.y = median, geom='line', 
               size=.7, color='magenta', aes(group=1)) 
...
p <- ggplot(rs_outliers, aes(x=quality, y=residual.sugar, group = quality, 
                             color=quality)) + 
...
ggplot(rwine, aes(x = quality, y = chlorides, group=quality)) + 
  geom_boxplot(color='purple') +
  geom_jitter( position = position_jitter(0.3), alpha=0.08) +
  stat_summary(fun.y = median, geom='line', 
               size=.7, color='magenta', aes(group=1))
...
p <- ggplot(c_outliers, aes(x=quality, y=chlorides, group = quality, 
                             color=quality)) + 
    geom_violin(trim=FALSE)
...
ggplot(rwine, aes(x = quality, y = pH, group=quality)) + 
  geom_boxplot(color='purple') +
  geom_jitter( position = position_jitter(0.3), alpha=0.05) +
  stat_summary(fun.y = median, geom='line', 
               size=.7, color='magenta', aes(group=1)) +
  geom_text(data=q_pH, aes(x = quality, y = med, label = med), 
              size = 4, color= 'blue', vjust = -1)
...
ggplot(rwine, aes(x = quality, y = sulphates, group=quality)) + 
  geom_boxplot(color='purple') +
  geom_jitter( position = position_jitter(0.3), alpha=0.05) +
  stat_summary(fun.y = median, geom='line', 
               size=.7, color='magenta', aes(group=1)) +
  geom_text(data=q_sulphates, aes(x = quality, y = med, label = med), 
              size = 4, color= 'blue', vjust = -1)
...
p <- ggplot(sph_outliers, aes(x=quality, y=sulphates, group = quality, 
                             color=quality)) + 
    geom_violin(trim=FALSE)
...
g <- ggplot(rwine, aes(quality, alcohol.levels))
...
```{r sulphates_vs_citric.acid_by_quality_and_alcohol_levels}

ggplot(rwine, aes(x=citric.acid, y=sulphates)) + 
  geom_line(aes(color = quality.levels), stat = 'summary', fun.y = mean) 
...
```{r}
ggplot(rwine, aes(x=citric.acid, y=sulphates)) + 
  geom_violin(aes(fill=factor(alcohol.levels)), alpha=.4, size=1) +
  facet_wrap(~quality.levels)
...
From the plots citric.acid versus sulphates, I notice that in the 78_quality wines the quantity of sulphates is more consistent. The high peaks in sulphates are seen in the other two groups of wines. 
...
ggplot(rwine, aes(x = quality, y = alcohol, group=quality)) + 
  ...
  geom_text(data=q_alcohol, aes(x = quality, y = med, label = med), 
              size = 4, color= 'blue', vjust = -1) +
  labs(title = "Alcohol by Quality Boxplots", x="Quality", y="Alcohol")+
  scale_x_continuous("Quality", labels = as.character(qlevels), breaks = qlevels)
...
ggplot(best_wines, aes(x=sulphates, y=citric.acid)) + 
  geom_violin(aes(fill=factor(alcohol.levels)), alpha=.7, size=.5) +
  labs(title = "Citric Acid by Sulphates for 78_Quality Wines", 
       x="Sulphates", y="Citric Acid")
...
The violin diagram is only for the best wines in the data set, those of qualities 7 and 8. It contains information about the three attributes that have the most direct correlation with quality: sulphates, citric acid and alcohol. If we consider the high alcohol wines in this subset, we notice that most of the samples with citric acid of about 0.40 have a wide range of sulphates. The sulphates levels vary much less if the citric acid is around 0.2 or 0.6.
